...
def run_interactive():
    ...
    parser.add_argument("--column", type=int, default='ERROR', 
                        help="Plot column number X")
    parser.add_argument("--save", default=None, 
                        help="Saves the plot")
    parser.add_argument("--extension", default="svg",
                        help="Saves as svg/pdf/jpg/png")
    parser.add_argument("--t_min", type=int, default=0, 
                        help="in value for time")
    parser.add_argument("--load", default=None,
                        help="Loads the file(s) with the data (sep by comma)")
    parser.add_argument("--y2", default=None, 
                        help="Loads this other column from files to plot in y2")
    ...
    if args.column is None:
        ...
        if args.load and args.save:
            ...
            plot.plot(args.column, args.save, 
                      args.extension, args.t_min, args.y2, None)
        else:
